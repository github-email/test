...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "K2yHVYmaP7BmBTa2QuCilzwfYsF3pKvrsMzlo56K";
    private static final String SECRETKEY = "no01WDyWKN1-_YsLuq9XaxbSThC3WrPwPkWdFgu0";
    private static final String BUCKET = "xh-imgs-servers";
    public static final String DOMAIN= "http://qh0d6giaz.hn-bkt.clouddn.com/";
